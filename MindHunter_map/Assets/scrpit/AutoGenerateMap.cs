...
public class AutoGenerateMap : MonoBehaviour{
    ...
    public void autoGenerate(){
        ...
        */
        AutoGenerationAvatars autoGenerateAvatars = new AutoGenerationAvatars(2, 2, player, servant, fighter, boss, config);
        autoGenerateAvatars.generateBoss();
        autoGenerateAvatars.generatePlayer();
        autoGenerateAvatars.generateServants();
        autoGenerateAvatars.generateFighters();
    }
}
